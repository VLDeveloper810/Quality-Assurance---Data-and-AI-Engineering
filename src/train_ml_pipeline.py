...
def run_ml_training_pipeline():
    ...
    print(
        f"--> [Data Source] Reading consolidated records from Iceberg: {target_table}"
    )
    ...
    df_ml_input = df_iceberg.withColumn(
    ...
    lr = LogisticRegression(
        featuresCol="features", labelCol="high_profit_indicator", maxIter=10
    )
