...
if __name__ == "__main__":
    ...
    run_script("./mock_data_generator/generate_mock_data.py", "Data Generation & AWS S3 Upload")
    ...
    run_script("./src/train_ml_pipeline.py", "Feature Engineering & Spark ML Model Training")
    
    print("\n" + "🎉"*30)
    print("🔥 ALL PIPELINE PHASES EXECUTED AND COMMITTED SUCCESSFULLY!")
    print("👉 Run 'mlflow ui' in your terminal to see your registered model parameters.")
    print("🎉"*30)